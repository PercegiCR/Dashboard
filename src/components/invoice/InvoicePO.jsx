...
const InvoicePO = ({ setActiveTab }) => {
  const { purchaseOrders, vendors } = useAppContext();
      ...
      <div className="bg-white text-slate-900 p-10 rounded-2xl shadow-xl print:shadow-none print:rounded-none print:p-0">
        <div className="flex justify-between items-start border-b-2 border-slate-200 pb-8 mb-8">
          <div className="flex items-center gap-3">
            <div className="text-indigo-600 bg-indigo-50 p-3 rounded-xl border border-indigo-100">
              <Building2 size={40} />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-slate-900 tracking-wide">KopiERP (KopiSistem)</h1>
